...
public class Retailer2 {
    ...
    @Test
    public void Test13_search_order_in_invoices() {
        WebDriverWait wait = new WebDriverWait(driver, 60);

        System.out.println("===> TEST 13: SEARCH ORDER IN INVOICES");

        driver.get("https://dev.digisposa.com/finances");

        driver.findElement(By.xpath("//*[@id=\"invoices\"]/div/div[1]/div/div[1]/div[1]/input")).sendKeys("1592315715");
        ...
        Assert.assertEquals(OrderNumb, "#1592315715");
